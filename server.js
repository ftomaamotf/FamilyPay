...
// ================= 9. Realtime Intercom System (Disabled) =================
const disabledIntercomResponse = (res) =>
  res.status(410).json({
    success: false,
    message: 'تم إلغاء ميزة الاتصال بين المستخدمين والأدمن.'
  });

app.post('/api/intercom/call', (req, res) => disabledIntercomResponse(res));
app.post('/api/intercom/respond', (req, res) => disabledIntercomResponse(res));
app.post('/api/intercom/voice-burst', (req, res) => disabledIntercomResponse(res));
app.get('/api/intercom/status/:callId', (req, res) => disabledIntercomResponse(res));
app.get('/api/intercom/active-for/:userId', (req, res) => disabledIntercomResponse(res));
